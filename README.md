...
[![Java CI](https://github.com/kjoivmasopkpaoksd4/jt6/actions/workflows/1.pipeline.yml/badge.svg)](https://github.com/kjoivmasopkpaoksd4/jt6/actions/workflows/1.pipeline.yml)
...
[![Javadoc](https://img.shields.io/badge/JavaDoc-Online-green)](https://kjoivmasopkpaoksd4.github.io/jt6/javadoc/)
...
## CI/CD Pipeline
The heart of this template is the ['Main GitHub Actions CI/CD Pipeline'](https://github.com/kjoivmasopkpaoksd4/jt6/actions/workflows/1.pipeline.yml).
...
Please define the secrets via your repository settings. ([Settings > Security > Secrets and variables > Actions](https://github.com/kjoivmasopkpaoksd4/jt6/settings/secrets/actions))
...
To host the generated Javadoc, configure GitHub Pages for your repository to deploy from branch `gh-pages`. You can also find all deployments under ['pages-build-deployment'](https://github.com/kjoivmasopkpaoksd4/jt6/actions/workflows/pages/pages-build-deployment).
...
The libraries gradle dependencies are scanned for known [CVE](https://www.cve.org/) with **[aquasecurity/trivy](https://github.com/aquasecurity/trivy)**. The scan results can be reviewed and managed under [Security > Vulnerability alerts > Code scanning](https://github.com/kjoivmasopkpaoksd4/jt6/security/code-scanning).
